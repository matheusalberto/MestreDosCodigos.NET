using MestreDosCodigos_POO_Conceitos.Abstracao;
using MestreDosCodigos_POO_Conceitos.Encapsulamento;
using MestreDosCodigos_POO_Conceitos.ExemplosInterfaces.Cloneable;
using MestreDosCodigos_POO_Conceitos.ExemplosInterfaces.Disposable;
using MestreDosCodigos_POO_Conceitos.ExemplosInterfaces.Enumerable;
using MestreDosCodigos_POO_Conceitos.Polimorfismo;
using System;
using System.Collections;
using System.Collections.Generic;

namespace MestreDosCodigos_POO_Conceitos
{
    class Program
    {
